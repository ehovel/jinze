...
<div class="nspMainPortalMode5<?php if($this->parent->config['autoanim'] == TRUE) echo ' autoanim'; ?> nspFs<?php echo $this->parent->config['module_font_size']; ?>" id="nsp-<?php echo $this->parent->config['module_id']; ?>">
