    ...
    <div id="enregistrement">
    	<div>
			...
			<?php 
                    ...
                    $icon=JURI::base().'images/contactmap/icons/'.$row->icon;
                    };
                    if (($linkok)&&($row->icon<>'')) { ?>
        ...
        <table class="contactmap_detail">
            ...
            <?php if (($row->email_to!=null) and ($this->params->get('show_email_field', 1))) { if ($this->params->get('show_email', 1)) echo '<label>'.JText::_('GMAPFP_EMAIL');?> </label><span><?php echo @JHTML::_('email.cloak',$row->email_to);?></span><br /> <?php };?> 
