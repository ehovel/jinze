...
.inputbox {font-size: 11px;}
    ...
    <form action='index.php?option=com_contactmap&controller=contactmap&task=upload_image&tmpl=component' method='post' id='adminForm' name='adminForm' enctype='multipart/form-data' onsubmit='return control();'>
