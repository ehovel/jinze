...
return '
		...
		<script src="http://maps.google.com/maps/api/js?sensor=true&language='.$tag_lang.'" type="text/javascript"></script>
		...
		<script language="javascript" type="text/javascript">//<![CDATA[
			...
			function init() {
				...
				lat = document.adminForm.jform_contactmap_centre_lat.value;
				lng = document.adminForm.jform_contactmap_centre_lng.value;
				zoom_carte = parseInt(document.adminForm.jform_contactmap_zoom.value);
			  ...
			  google.maps.event.addListener(map, "bounds_changed", function() {
				   document.adminForm.jform_contactmap_zoom.value = map.getZoom();
			  });
			  ...
			  google.maps.event.addListener(marker1, "drag", function() {
				document.adminForm.jform_contactmap_centre_lat.value = marker1.getPosition().lat();
				document.adminForm.jform_contactmap_centre_lng.value = marker1.getPosition().lng();
			  });
			}
